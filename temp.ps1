...
Get-ChildItem -Path "$desktopPath\$folderWithProcessedDocuments" -Directory | % {
    ...
    New-Item "$desktopPath\$folderWithProcessedDocuments\Temporary bmp" -Type directory
    New-Item "$desktopPath\$folderWithProcessedDocuments\Temporary bmp for WM" -Type directory
    ...
    #Renames marked bmp images back to WDP
    Rename-Item 
