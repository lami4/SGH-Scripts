...
<body>
<div>
<h4>Данные ошибки должны быть исправлены перед применением изменений:</h4>
<div>
</div>
<table style=""width:100%"">
    <tr>
        <th class=""Item_Number"">№</th>
        <th class=""Details"">Описание ошибки</th>
    </tr>" -Encoding UTF8
$ErrorCounter = 1
$Errors | % {
...
Function ApplyChangesForm ()
{
    ...
    $ApplyChangesFormFilesBeingPublishedLabel.Width = 402
    ...
    $ApplyChangesFormCurrentVersionLabel.Width = 402
    ...
    $ApplyChangesArchiveFolderLabel.Width = 402
    ...
    $ApplyChangesFormBackupLabel.Width = 402
